...
The network grows in groups of five. AQGreen has three structural levels: 5, 25, and 125 qualifying people. Level 3 is the final AQGreen level. Onyx separately has five structural levels: 5, 25, 125, 625, and 3,125. A level is complete only when every required branch at that depth is complete; four direct recruits do not earn a partial Level 1.
